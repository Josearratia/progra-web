...
if (isset($_SESSION['user'])) {
    ...
    if (
        $rolesaccess->getrolaccess_addconsolas() == 0
        && $rolesaccess->getrolaccess_Modificarconsolas() === 0
        && $rolesaccess->getrolaccess_deletconsolas() === 0
    ) {
            ...
            <div class="col-sm-12 align-self-center text-center">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <h4>
                            <?php if ($rolesaccess->getrolaccess_addconsolas() == 1) {
                                echo '<a href="../consolas/agregar.php">
                                ...
                                <tbody>
                                    ...
                                    if ($consulta->rowCount() > 0) {
                                        while ($row = $consulta->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo '<td>' . $row['Numero_consola'] . '</td>';
                                            echo '<td>' . $row['NumeroSerie_consola'] . '</td>';

                                            if (

                                                $rolesaccess->getrolaccess_Modificarconsolas() === 1
                                            ...
                                            if (
                                                $rolesaccess->getrolaccess_deletconsolas() === 1
                                            ) {
                                                if ($row['borrado'] == 1) {
                                                    echo '<td>
