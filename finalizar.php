...
if (isset($_SESSION['user'])) {
    ...
    if (isset($_POST['consola'])) {
        $idconsola = $_POST['consola'];
        $consola->getallonlyone($_POST['consola']);
    }
    ...
    <section id="" class="promotion section-bg">
        <div class="containe ">
            ...
            <div class="section-title">
                <h2>Realizar un renta</h2>
            </div>
            <div class="row justify-content-center h-100">
                <div class="col-lg-8 mt-5 mt-lg-0">
                    <form action="/forms/finalizar.php" method="post" role="form" class="promociones-form" data-aos="fade-down-left">

                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <input id="idconsola" name="idconsola" type="hidden" value="<?php echo $consola->getid(); ?>">
                                <input id="costo" name="costo" type="hidden" value="<?php echo $consola->getcosto(); ?>">
                                <h6>Consola = <?php echo $consola->getnombre(); ?></h6>
                            </div>
                        </div>
