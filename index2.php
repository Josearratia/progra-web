...
<body>
    ...
    <h1>Página web informativa con las secciones:  inicio, plataformas (consolas),  juegos (títulos, con base en el punto 2.1.3),  ubicación, contacto, galería, torneos, registrarse e iniciar sesión. (Tomar como referencia</h1>
    <!-- endheader -->
