...
if (isset($_SESSION['user'])) {
    ...
    if ($rol->getrolaccess_modificarjuegos() == 1) {
        if (isset($_POST['id'])) {
            $juego->set($_POST['id']);
        } else {
        ...
        <div class="containe ">
            ...
            <div class="row justify-content-center h-100">
                <div class="col-lg-8 mt-5 mt-lg-0">
                    <form action="../forms/modificarjuego.php" method="post" role="form" class="promociones-form" enctype="multipart/form-data" data-aos="fade-down-left">

                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <input type="hidden" name="id" value="<?php echo $juego->getid(); ?>"/>
                                <input type="text" name="nombre" class="form-control" id="nombre" value="<?php echo $juego->getnombre(); ?>" placeholder="Nombre" data-rule="required" data-msg="Por favor introduzca un nombre para la consola" />
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <input type="text" name="descripcion" class="form-control" value="<?php echo $juego->getdescripcion(); ?>" id="descripcion" placeholder="Descripcion" data-rule="required" data-msg="Por favor introduzca un descripcion para la consola" />
                                <div class="validate"></div>
                            </div>
                        </div>
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <input type="hidden" name="oldname" value="<?php echo $juego->getimagen(); ?>"/>
                                <img src="/assets/upload/imgjuegos/<?php echo $juego->getimagen(); ?>" alt="<?php $juego->getimagen(); ?>" class="juego">
                            </div>
                        </div>
