        ...
        <div class="containe ">
            ...
            <div class="row justify-content-center h-100">
                <div class="col-lg-8 mt-5 mt-lg-0">
                    <form action="finalizar.php" method="post" role="form" class="promociones-form" data-aos="fade-down-left">
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                ...
                                <select name="consola" class="form-control">
                                    <?php
                                    $consulta = $consola->getallandtarifa();
                                    $i = 0;
                                    if ($consulta->rowCount() > 0) {
                                        while ($row = $consulta->fetch(PDO::FETCH_ASSOC)) {
                                            echo '<option value="' . $row['idConsola'] . '"> Nombre De Consola --  ' . $row['Nombre_consola'] . ' -- Costo --' . $row['costo'] . '</option>';
                                        }
                                    }
                                    ?>
                                </select>
