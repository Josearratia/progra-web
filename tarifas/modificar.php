                                    ...
                                    if ($consulta->rowCount() > 0) {
                                        while ($row = $consulta->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo '<td>' . $row['costo'] . '</td>';
                                                ...
                                                echo '<td>
                                                <form action="../tarifas/modificart.php" method="post" role="form" id="modificar">
                                            ...
                                            echo '<td>
                                                        <form action="../forms/eliminartarifa.php" method="post" role="form" id="eliminar">
                                                        <input name="id" type="hidden" value="' . $row['id'] . '">
