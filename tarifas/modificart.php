        ...
        <div class="containe ">
            ...
            <div class="row justify-content-center h-100">
                <div class="col-lg-8 mt-5 mt-lg-0">
                    <form action="../forms/modificartarifa.php" method="post" role="form" class="promociones-form" data-aos="fade-down-left">

                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <input id="id" name="id" type="hidden" value="<?php echo $tarifas->getid(); ?>">
                                <h6>Nombre de la trarifa: </h6>
                                <input type="text" name="nombre" value="<?php echo $tarifas->getnombre(); ?>" class="form-control" id="nombre" placeholder="Nombre" data-rule="required" data-msg="Por favor introduzca un nombre para la tarifa" />
                        ...
                        <div class="form-row justify-content-center">
                            <div class="col-md-6 form-group">
                                <h6>Costo: </h6>
                                <input type="text" name="costo" class="form-control" value="<?php echo $tarifas->getcosto(); ?>" id="descripcion" placeholder="Descripcion" data-rule="required" data-msg="Por favor introduzca un costo de tarifa" />
                                <div class="validate"></div>
                            </div>
                        </div>
